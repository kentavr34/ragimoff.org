...
IN_PROGRESS = {
    # 6D81 и 6D83 прочитаны только машинными сканами; §5–§6 (NINDS-AIREN,
    # шкала Хачинского, Rascovsky 2011, C9orf72/MAPT/GRN) ещё не сверены
    '6D': 'сверен, кроме 6D81 и 6D83',
}
