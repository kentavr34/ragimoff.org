...
def build_map() -> dict[str, str]:
    ...
    # окончания прилагательных, причастий и существительных; основа при
    # отсечении обязана остаться не короче шести букв — «приём», «полёт»,
    # «объём», «учёт» короче, и по ним «приемлемый» стал бы «приёмлемым»
    END = ('остями', 'остях', 'остью', 'остей', 'остям', 'ости', 'ость',
           'ыми', 'ого', 'ому', 'ими', 'его', 'ему', 'ами', 'ах', 'ам', 'ов',
           'ый', 'ая', 'ое', 'ые', 'ым', 'ом', 'ой', 'ую', 'ых', 'ий', 'яя',
           'ее', 'ие', 'им', 'ем', 'ей', 'юю', 'их', 'ями', 'ях', 'ия', 'ию',
           'ие', 'ей', 'я', 'ю', 'а', 'ы', 'у', 'е', 'и')
    stems = set()
